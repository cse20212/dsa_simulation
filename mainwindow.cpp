...
void MainWindow::createActions() {
    ...
    toBegin->setIcon(QIcon("/Users/marykatewilliams/FinalProject/dsa_simulation/beginButton.png"));
    ...
    previousFrame->setIcon(QIcon("/Users/marykatewilliams/FinalProject/dsa_simulation/backButton.png"));
    ...
    nextFrame->setIcon(QIcon("/Users/marykatewilliams/FinalProject/dsa_simulation/nextButton.png"));
    nextFrame->setStatusTip(tr("Next Step"));
    connect(nextFrame, SIGNAL(triggered()), this, SLOT(go_forward()) );

    toEnd = new QAction(tr("End"),this);
    toEnd->setIcon(QIcon("/Users/marykatewilliams/FinalProject/dsa_simulation/endButton.png"));
